...
public class MainActivity extends AppCompatActivity {
    ...
    /** onCreate method that runs when the app runs
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityResultLauncher = registerForActivityResult(new
                ...
                ActivityResultCallback<ActivityResult>() {
                     ...
                     *
                     * @param result - gets information about a picture
                     * @return nothing
                     */
                    @Override
    ...
    private class GrayChangeHandler implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar,
            ...
            if (fromUser) {
                ...
                // gray scale the picture
                bitmap = grayer.grayScale();

                // set new grayed image
                imageView.setImageBitmap(bitmap);
            }
        }
    ...
    public void send(View view) {
        try {
            ...
            // An intent to send data to someone
            Intent emailIntent = new Intent(Intent.ACTION_SEND);

            // Sets the MIME data type of this intent
            emailIntent.setType("image/png");

            // Adds data to this intent with a key-value pair (key = name, value = data)
            // EXTRA_SUBJECT - specify a subject line in a message
            ...
            Toast.makeText(this, "EMAIL PICTURE", Toast.LENGTH_LONG).show();
